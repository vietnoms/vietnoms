export const RESTAURANT = {
  ...
  // Square Online ordering page with On-Demand Delivery enabled in the Square dashboard.
  // TODO: confirm this points to the Square Online delivery ordering page (e.g. *.square.site).
